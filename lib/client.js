...
var Hulk = function (opts) {
  this.opts = opts || {};
  this.opts.host = this.opts.host || 'localhost';
  this.opts.port = this.opts.port || '8080';
  this.opts.protocol = this.opts.protocol || 'http://';

  if (this.opts.secure && this.opts.protocol != 'https://') {
    this.opts.protocol = 'https://';
  }
  ...
  this.subscribe = function (channel, callback) {
    var hulk = this;
    var source = new EventSource(this.opts.protocol + this.opts.host + ':' + this.opts.port + '/stream.json?stream=' + channel);
